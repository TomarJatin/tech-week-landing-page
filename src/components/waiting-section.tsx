...
export function WaitingSection() {
  ...
  return (
    <section className="py-12 sm:py-14 md:py-16 px-4 sm:px-6">
      <NeonGradientCard className="w-full h-[250px] sm:h-[280px] md:h-[333px] items-center justify-center text-center">
        <div className="w-full h-full flex flex-col items-center justify-center gap-6 sm:gap-8 md:gap-10 px-6 sm:px-12 md:px-16 z-10">
        <h2 className="text-2xl sm:text-3xl md:text-6xl font-semibold bg-gradient-to-r from-[#FFF]/80 to-[#999]/30 bg-clip-text text-transparent px-4 sm:px-0">
