  ...
  return (
    <div className="min-h-screen text-foreground relative">
      ...
      <div className="w-full pb-[100px] sm:pb-[150px] md:pb-[200px] opacity-70 ">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl text-center mb-6 sm:mb-7 md:mb-8 lg:text-6xl font-semibold bg-gradient-to-r from-[#FFF]/80 to-[#999]/30 bg-clip-text text-transparent pb-4">
        You&apos;re special, and humanity <br className="hidden sm:block"/> is counting on you
        </h2>
        
        <a href="https://cal.com/nijansh-heizen/ny-tech-week" target="_blank" className="relative inline-flex overflow-hidden rounded-[12px] p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
